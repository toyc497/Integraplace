...
from Environments.Variables import keycloak, api_uri


def logout(auth_data):
    uri = f'{keycloak["url"]}/realms/{keycloak["realm"]}/protocol/openid-connect/logout'
...
def get_acess_token():
    uri = f'{keycloak["url"]}/realms/{keycloak["realm"]}/protocol/openid-connect/token'
