...
def get_chat(identifier, captcha):
    ...
    try:
        response = requests.get(uri, headers=headers, verify=True, timeout=60)
...
def refresh_hcaptcha(driver, hcaptcha_id):
    sleep(1)
